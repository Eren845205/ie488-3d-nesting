...
|---|---|---|---|
| plan1 | **140.21** (K-56g pin; soft sözleşme kalıcı) | **129.00 — OTOMATİK zincir LEGAL** (K-62 v17 HAM-PIN fix'li motor, k62_kapi 2026-08-06: el-ayarsız z=65,3 + öncelik üçlü; A11 şerhi: tek-set. El-reçete kolu: 131.40 v17c-LEGAL [v13b üçlü+settle]. ⚠️ Eski 130.80 [v14] ve eski otomatik 135.60 ÇİFT-DILATION'LI ESKİ MOTOR — fix sonrası yeniden-üretilemez, tarihsel referans) | otomatik-zincir; results/k62_kapi.json (fix'li) + k62_v17c_ripup_settle.json · tarihsel: k62_v14_kilit.json |
