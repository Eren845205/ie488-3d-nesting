...
| **F2-v2** | Sökülebilirlik-farkındalı NFV decode (+Z-erişilebilirlik kısıtı YERLEŞTİRME anında) + NFV-clearance kablosu | 6GB | Yüksek | **ORTA-YÜKSEK (EVAL-1 ile YÜKSELDİ 2026-07-06)** | K-21: NFV@1.0 kabukta 554/588 kilit. **EVAL-1: PLAN ailesinde de plan1 81 / plan3 87 kilit + clearance 0.055-0.083 → NFV kalite modu A2-İLLEGAL, şampiyonluktan düştü.** Ünlü ~%20-28 plan kazançlarını KURTARMANIN tek yolu bu iş (legal decode + pitch-türevli clearance). Kabuktaki K-22b mini-hali NO-GO'ydu ama plan ailesi geometrisi farklı (kavite az, kilit muhtemelen rim-temas kaynaklı → daha çözülebilir olabilir). Ölç-önce: önce plan1'de kilit ANATOMİSİ teşhisi (hangi parçalar, neden). |
