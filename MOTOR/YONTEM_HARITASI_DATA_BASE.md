...
|---|---|---|---|
| plan1 | **140.21** (K-56g pin; soft sözleşme kalıcı) | **130.80** (K-62 v13b reçetesi [kanopi 3D-pin z=67 + kule-önceliği + TAPER@r1 + settle pin-farkında]; **LEGAL kanıtlı v14 2026-08-05**: 112/112, clear 2.447, 5-yön kilit=0 — A11 şerhi: tek-set; otomatik kablo LEGAL'i **135.60** [k62_kapi geri-düşüş, söküm-planlı] — el-ayarsız, üretim-adayı) | şampiyon-reçete; results/k62_v14_kilit.json + k62_v13b_greedy.json + k62_kapi.json |
