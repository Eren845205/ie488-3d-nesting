...
| MK-03 | **KAFES/çubuk-arası interleave**: aşan-çubuk kolonları + kanallara kitle-plaka + kalan NFV | fsm610 516 z-anatomisi (çubuk-üstü yığılma teşhisi) | tekrar-kitle payı≥0,5 + plaka-aşan parça | **PROTOTİP GO-ADAYI** — fsm610 458,40 LEGAL (−%11,2, tek-set ŞERHLİ); sentetik +6,9mm | K-66-d; kapı: çok-seed dağılımsal + sıfır-dokunuş |
